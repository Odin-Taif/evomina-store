...
import { CounterContext, actionType } from "@/app/context/counter.context";
type Props = {
      ...
      <div className="relative">
        <div className={"md:w-[250px] border-l-[0.5px] border-r-[0.5px]"}>
          ...
          <div className="border-b-[0.5px] pb-10">
            ...
            <div className="grid grid-cols-2 gap-2 px-2 overflow-hidden">
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full outline-none border-[1px] rounded-lg px text-center py-[2px]"
                    type="number"
                    name="min"
