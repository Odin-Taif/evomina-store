        ...
        <div className="flex flex-col gap-1 py-3 pb-5 tet-sm text-neutral-600 border-b-[0.5px]">
          <span
            className={`py-3 px-5 hover:cursor-pointer hover:bg-amber-100 ${
              selectedCategories.includes("All Products") ? "bg-amber-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 hover:cursor-pointer hover:bg-amber-100 ${
              selectedCategories.includes("Accessories") ? "bg-amber-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 hover:cursor-pointer hover:bg-amber-100 ${
              selectedCategories.includes("Incense cones") ? "bg-amber-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 hover:cursor-pointer hover:bg-amber-100 ${
              selectedCategories.includes("Frankincense") ? "bg-amber-50 " : ""
            }`}
          ...
          <span
            className={`py-3 px-5 hover:cursor-pointer hover:bg-amber-100 ${
              selectedCategories.includes("Essential oil") ? "bg-amber-50" : ""
            }`}
