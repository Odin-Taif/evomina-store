...
export default function CategoryCollections() {
  return (
    <>
      <div className="2xl:mx-auto 2xl:container py-2 px-2 sm:px-2 xl:px-2 2xl:px-0 w-full border">
      ...
      <div className="2xl:mx-auto 2xl:container py-2 w-full px-2 sm:px-2 xl:px-2 2xl:px-0 ">
