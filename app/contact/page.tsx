...
import SocialMediaBar from "@/components/SocialMediaBar"; // It seems like SocialMediaBar is imported but not used in this file.
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <p className="text-base leading-relaxed mb-9 text-body-color">
                    ...
                    office@friends-in-flats.at. Your messages will be stored for
                    six months to process your request and for any follow-up
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-base text-body-color">
                        Friends in Flats, GmbH Marxergasse 24 1030 Wien
                      </p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                  ...
                  <div>
                    <button
                      ...
                      className="inline-flex items-center gap-3 relative disabled:opacity-70 px-2 mx-1 disabled:cursor-not-allowed rounded hover:opacity-80 transition bg-teal-500 w-full border-teal-500 text-white text-sm py-2 font-light border-[1px]"
                    >
                      <BsFillSendCheckFill />
                      <span>Send</span>
                      <MoonLoader
